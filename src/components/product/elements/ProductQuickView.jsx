                  ...
                  <div className="col-lg-7 mb--40">
                    <div className="row">
                      <div className="col-lg-10 order-lg-2">
                        ...
                        >
                          {[
                            getQuickViewItem.thumbnail1,
                            getQuickViewItem.productimage1,
                            getQuickViewItem.productimage2,
                            getQuickViewItem.productimage3,
                            getQuickViewItem.productimage4,
                            getQuickViewItem.productimage5,
                          ].map((image, index) => (
                    ...
                    <div className="single-product-content">
                      <div className="inner">
                        ...
                        <div className="product-variations-wrapper">
                          {Array.isArray(getQuickViewItem.colorAttribute) &&
                            getQuickViewItem.colorAttribute.length > 0 && (
                          ...
                          {Array.isArray(getQuickViewItem.sizeAttribute) &&
                            getQuickViewItem.sizeAttribute.length > 0 && (
