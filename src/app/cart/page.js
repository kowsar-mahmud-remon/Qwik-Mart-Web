...
import { calculateTotalAmount, slugify } from "@/utils";
                            ...
                            <div className="col-xl-5 col-lg-7 offset-xl-7 offset-lg-5">
                                ...
                                <div className="summery-table-wrap">
                                    ...
                                    <tbody>
                                        ...
                                        <td>Subtotal</td>
                                        <td>${calculateTotalAmount(cartProducts.cartItems)}</td>
                                        </tr>
                                        ...
                                        <td>Total</td>
                                        <td className="order-total-amount">${calculateTotalAmount(cartProducts.cartItems)}</td>
                                        </tr>
                                    </tbody>
                                    </table>
                                </div>
