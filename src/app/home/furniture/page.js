...
const HomeFurniture = () => {
  ...
  const [prodData, setProdData]=useState([]);
    ...
    const furnitureProduct = prodData.filter(data => slugify(data.pCate) === pageCategory);
    const transparentProduct = prodData.filter(data => slugify(data.pCate) === pageCategory && data.thumbnailTransparent === true);
