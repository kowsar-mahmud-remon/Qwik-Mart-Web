                                        ...
                                        <div className="inner">
                                            ...
                                            <div className="product-action-wrapper d-flex-center">
                                                ...
                                                <ul className="product-action action-style-two d-flex-center mb--0">
                                                    <li className="add-to-cart"><Link href={singleData.buyUrl} className="axil-btn btn-bg-primary">Buy Product</Link></li>
                                                </ul>
                                                {/* End Product Action  */}
                                            </div>
                                                ...
                                                <div className="row align-items-center">
                                                    ...
                                                    <div className="col-md-6">
                                                        <div className="nft-verified-option">
                                                            ...
                                                            <Link className="verify-btn axil-btn btn-bg-secondary" href={`https://www.google.com/search?q=${slugify(singleData.title)}`}>Verifiy</Link>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div className="container">
                                                    <ul className="nav tabs" id="myTab" role="tablist">
                                                        <li className="nav-item" role="presentation">
                                                            <Link className="active" id="description-tab" data-bs-toggle="tab" href="#description" role="tab" aria-controls="description" aria-selected="true">Description</Link>
                                                        </li>
                                                        <li className="nav-item " role="presentation">
                                                            <Link id="additional-info-tab" data-bs-toggle="tab" href="#additional-info" role="tab" aria-controls="additional-info" aria-selected="false">Additional Information</Link>
                                                        </li>
                                                        <li className="nav-item" role="presentation">
                                                            <Link id="reviews-tab" data-bs-toggle="tab" href="#reviews" role="tab" aria-controls="reviews" aria-selected="false">Property</Link>
                                                        </li>
                                                    </ul>
