                ...
                <div className="col-lg-10 order-lg-2">
                  <div className="single-product-thumbnail-wrap">
                    ...
                    >
                      ...
                      {[
                        singleData.thumbnail1,
                        singleData.productimage1,
                        singleData.productimage2,
                        singleData.productimage3,
                        singleData.productimage4,
                        singleData.productimage5,
                      ].map((image, index) => (
                        <div className="thumbnail" key={index}>
                          <Image
                            src={image}
                ...
                <div className="inner">
                  ...
                  <div className="product-variations-wrapper">
                    {singleData.colorAttribute &&
                      Array.isArray(singleData.colorAttribute) && (
                    ...
                    {singleData.sizeAttribute &&
                      Array.isArray(singleData.sizeAttribute) && (
          ...
          <div className="tab-content">
            ...
            >
              <div className="product-desc-wrapper">
                <div className="row">
                  {Array.isArray(singleData.description) &&
                ...
                <div className="row">
                  <div className="col-lg-12">
                    <ul className="pro-des-features">
                      {singleData.description?.map((data, index) => (
